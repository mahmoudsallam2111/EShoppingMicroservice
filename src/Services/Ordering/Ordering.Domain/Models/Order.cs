...
public class Order : Aggregate<OrderId>
{
    ...
    public static Order Create(OrderId id ,CusomrerId customerId, OrderName orderName, Address shippingAddress, Address billingAddress, Payment payment, OrderStatus status)
    {
        var order = new Order
        {
            Id = id,
